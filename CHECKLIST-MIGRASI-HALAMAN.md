...
- [x] `/awardee`: poin, tier, streak harian dari tanggal poin sah masuk dalam WIB, badge, kegiatan, Kabar, dan ringkasan Cerita seluruhnya dibaca dari PocketBase tanpa fallback data lokal. Tautan Forum tetap tersedia, tetapi status migrasi `/awardee/forum` dicatat terpisah di bawah.
...
- [x] `/awardee/profil`: identitas terverifikasi, edit profil aman, avatar tersinkron ke header dan Jejaring sesuai consent foto, kontak mentoring sesuai consent, visibilitas Jejaring, gamifikasi, statistik Cerita, consent berversi append-only, audit profil, profil usaha, kontak usaha, dan etalase maksimal lima produk memakai PocketBase.
