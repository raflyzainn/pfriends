...
- [x] `/awardee/forum`, `/verifikator/forum`, dan `/admin/forum`: kanal berbasis komunitas, pesan persisten, picker seluruh emoji Unicode, reply inline dan navigasi konteks, presence, REST API, serta pembaruan realtime SSE memakai PocketBase; tidak memakai queue atau WebSocket khusus.
