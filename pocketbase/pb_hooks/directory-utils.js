...
function item(app, awardee) {
	...
	return {
		...
		businessProfile: awardee.getString('community') === 'WOMENPRENEUR' ? {
			...
			employees: awardee.getInt('businessEmployees'), growthPercent: Number(awardee.get('businessGrowthPercent') || 0)
		} : null,
